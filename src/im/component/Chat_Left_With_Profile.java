...
public class Chat_Left_With_Profile extends javax.swing.JLayeredPane {
    ...
    private void initComponents() {
        ...
        IaImage = new im.swing.ImageAvatar();
        txt = new im.component.Chat_Item();

        setLayout(new javax.swing.BoxLayout(this, javax.swing.BoxLayout.LINE_AXIS));

        IaImage.setBorderSize(0);
        IaImage.setImage(new javax.swing.ImageIcon(getClass().getResource("/im/icon/testing/download.png"))); // NOI18N
    ...
    private im.swing.ImageAvatar IaImage;
    private javax.swing.JLayeredPane jLayeredPane1;
    private im.component.Chat_Item txt;
